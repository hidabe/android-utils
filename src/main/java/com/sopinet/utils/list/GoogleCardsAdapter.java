...
public class GoogleCardsAdapter extends BaseAdapter implements Filterable {
	...
	public GoogleCardsAdapter(Activity context, ImageTitleData[] data, ImageLoader imageLoader) {
	...
	public GoogleCardsAdapter(Activity context, List<ImageTitleData> data, ImageLoader imageLoader) {
